...
echo "Installing clojure..." >> /home/ubuntu/datasimlog.txt
...
echo "Installed Clojure, sleeping..." >> /home/ubuntu/datasimlog.txt
sleep 15
sudo curl -sL https://raw.githubusercontent.com/creationix/nvm/v0.35.3/install.sh -o install_nvm.sh
echo "Installing Node Verison Manager (NVM)..." >> /home/ubuntu/datasimlog.txt
...
echo "Installed NVM, sleeping..." >> /home/ubuntu/datasimlog.txt
sleep 20
